...
require_once APP_ROOT . '/include/classes/Mandrill/Templates.php';
require_once APP_ROOT . '/include/classes/Mandrill/Exports.php';
require_once APP_ROOT . '/include/classes/Mandrill/Users.php';
require_once APP_ROOT . '/include/classes/Mandrill/Rejects.php';
require_once APP_ROOT . '/include/classes/Mandrill/Inbound.php';
require_once APP_ROOT . '/include/classes/Mandrill/Tags.php';
require_once APP_ROOT . '/include/classes/Mandrill/Messages.php';
require_once APP_ROOT . '/include/classes/Mandrill/Whitelists.php';
require_once APP_ROOT . '/include/classes/Mandrill/Ips.php';
require_once APP_ROOT . '/include/classes/Mandrill/Internal.php';
require_once APP_ROOT . '/include/classes/Mandrill/Subaccounts.php';
require_once APP_ROOT . '/include/classes/Mandrill/Urls.php';
require_once APP_ROOT . '/include/classes/Mandrill/Webhooks.php';
require_once APP_ROOT . '/include/classes/Mandrill/Senders.php';
require_once APP_ROOT . '/include/classes/Mandrill/Exceptions.php';
...
class Mandrill {
    ...
    public function __construct($apikey=null) {
        ...
        curl_setopt($this->ch, CURLOPT_FOLLOWLOCATION, (ini_get('safe_mode') || ini_get('open_basedir') ? FALSE : TRUE));
