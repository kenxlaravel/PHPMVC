...
function getProperty($var){
	...
	if($var == 'billaccount') Return '510087208';
	if($var == 'dutyaccount') Return '510087208';
	if($var == 'accounttovalidate') Return '510087208';
	if($var == 'meter') Return '118581592';
	if($var == 'key') Return 'JgmiCposs1DTr0Wt';
	if($var == 'password') Return 'uj42MAL1CSw0tZ1ZaLZaLZrQWXj8';
	...
	if($var == 'account') Return '510087208';
