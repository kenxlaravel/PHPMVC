...
$objGroupingPage    = GroupingPage::create($page->getId());
$objCategoryPage    = CategoryPage::create($objGroupingPage->getCategoryId());
$objSubcategoryPage = SubcategoryPage::create($objGroupingPage->getSubcategoryId());
$objOrder = new Orders();
...
echo Template::generate('base-sec/grouping-template', $templateInfo);